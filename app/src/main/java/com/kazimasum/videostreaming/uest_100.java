...
public class uest_100 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uest100);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Est_100");
    ...
    public void processupload(Uri filepath)
    {
        ...
        final StorageReference reference=storageReference.child("uploads_est_100/"+System.currentTimeMillis()+".pdf");
