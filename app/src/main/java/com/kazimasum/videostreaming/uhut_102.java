...
public class uhut_102 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uhut102);


        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);

        storageReference= FirebaseStorage.getInstance().getReference();
        databaseReference= FirebaseDatabase.getInstance().getReference("hut_102");
    ...
    public void processupload(Uri filepath)
    {
        ...
        final StorageReference reference=storageReference.child("uploads_hut_102/"+System.currentTimeMillis()+".pdf");
