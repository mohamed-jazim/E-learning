...
public class us3_sct_201 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_us3_sct201);

        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);

        storageReference= FirebaseStorage.getInstance().getReference();
        databaseReference= FirebaseDatabase.getInstance().getReference("cst_201");
    ...
    public void processupload(Uri filepath)
    {
        ...
        final StorageReference reference=storageReference.child("uploads_cst_201/"+System.currentTimeMillis()+".pdf");
