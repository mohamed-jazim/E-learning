...
public class ucyt_100 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucyt100);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("cyt_100");
    ...
    public void processupload(Uri filepath)
    {
        ...
        final StorageReference reference=storageReference.child("uploads_cyt_100/"+System.currentTimeMillis()+".pdf");
