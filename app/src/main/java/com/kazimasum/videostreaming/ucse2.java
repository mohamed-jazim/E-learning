...
public class ucse2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucse2);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("mydocumentsc1");
    ...
    public void processupload(Uri filepath)
    {
        ...
        final StorageReference reference=storageReference.child("uploadsc1/"+System.currentTimeMillis()+".pdf");
